...
[Pure Go](https://go.dev), zero CGO. [Charmbracelet](https://github.com/charmbracelet) + [GORM](https://gorm.io) + [SQLite](https://sqlite.org). 100% vibe-coded with [Claude](https://claude.ai) via [Cursor](https://cursor.com).
